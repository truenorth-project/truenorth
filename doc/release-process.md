...
* Update the following variables in [`src/kernel/chainparams.cpp`](/src/kernel/chainparams.cpp) for mainnet, testnet, and signet:
  ...
  - `m_assumeutxo_data` array should be appended to with the values returned by calling `truenorth-cli -rpcclienttimeout=0 -named dumptxoutset utxo.dat rollback=<height or hash>`
