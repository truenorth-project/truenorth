...
BOOST_AUTO_TEST_CASE(packet_test_vectors) {
    ...
    //
    // The inputs below are BIP324's, but the expected session ids, garbage
    // terminators and ciphertexts are not: BIP324Cipher::Initialize() salts the
    // key derivation with the network magic, so every derived value differs on
    // TrueNorth. These were regenerated from this implementation, which makes
    // this a self-consistency test rather than a conformance one. Conformance to
    // the underlying primitives is still covered against their own spec vectors
    // by crypto_tests (HKDF, ChaCha20, Poly1305) and ellswift_tests (ECDH).
    TestBIP324PacketVector(
        ...
        "",
        false,
        "9cf28043ebda207219f8a6b097dd3248",
        "b12a540c1a51300fcb6f09a8e1463444",
        "2e3a1e2559fc05d56eaf2f1c3ff9049d6a3598d0cd27f00c7dfda3f89259bc68",
        "af9bd70828a295f374a4137295e62144bf464d38a7",
        "");
    TestBIP324PacketVector(
        999,
        ...
        "",
        false,
        "2fcd2ba7e1cb23be5d86df4779e954cd",
        "b5e1e1f07d1798cfb5e3f02a7d06a55b",
        "5a29eb6cae2cbc99ead0679974f7e301e18766e8aacf19595717fa538078cc56",
        "6d536ab2452c3304e1fb697ed5c6512143ad1f1de20083a7d3a7c3a85a673a6a2d1364558c",
        "");
    TestBIP324PacketVector(
        0,
        ...
        false,
        "57828fa65af1481c12c989906835ee32",
        "0db1df5f954df9f6052663982c4d1aae",
        "0788c131683ac96204f50af4ede59ba3766ed78ad2e5f822efc13628cd00b1fa",
        "532dad326408c1201b5f498823a7d83c0b28ac72740ceff2301e89a8ae87a89737e674e9bd5c9c9afeb36bdf37deef0c517ff1ccf50311b79f07478bdf280d7d36aaa2db0d3414a2bfdd2e0afbb6234a614dc7",
        "");
    TestBIP324PacketVector(
        223,
        ...
        "",
        true,
        "397cdf01d354f042cbcaab35ce94585f",
        "9e4d8b95cfb35d4916aec09f29ebcf7b",
        "f7c3e074189e3f61be03d70005b82b4b8b033b930e8533637ef6ad1f534dc2b1",
        "",
        "");
    TestBIP324PacketVector(
        448,
        ...
        "",
        false,
        "3850faf67d601b7d994de0c6f5e9d12f",
        "955599bdd89e16d21b55f31a6416296b",
        "50eb044904e496fe4f2d23f335cacc2b3bdd28a2ea8fb43919fd4b9b70b41f9b",
        "",
        "");
    TestBIP324PacketVector(
        673,
        ...
        "",
        false,
        "4f09ec8f5ac4741d06f33b36de460a6a",
        "04278e1bbe7a7a2065fa58553882af76",
        "fbe973255aac55a84e35c52a9e4b648f1e9898d23191bf4cd95de97f6bd3f52f",
        "",
        "");
    TestBIP324PacketVector(
        1024,
        ...
        "",
        true,
        "9a7edc524aab567d86127d901cce42ac",
        "b8d8357415e34e8d2489cac0dcd82654",
        "350382ea17821c95802c5bef9f1ccfdda9b8b652ecb850c828578d1cd370f94e",
        "",
        "");
}
