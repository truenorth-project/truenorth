...
bool CheckBlock(const CBlock& block, BlockValidationState& state, const Consensus::Params& consensusParams, const uint256& seed_key, bool fCheckPOW = true, bool fCheckMerkleRoot = true);
