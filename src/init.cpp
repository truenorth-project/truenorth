 ...
 */
static const char* BITCOIN_PID_FILENAME = "truenorthd.pid";
/**
...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-testlaunchtime=<n>", "Reject blocks timestamped before this Unix time, exercising the mainnet launch-time rule (regtest only, default: 0 = rule disabled)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
#if HAVE_SYSTEM
