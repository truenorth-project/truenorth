...
bool ExtractDestination(const CScript& scriptPubKey, CTxDestination& addressRet)
{
    ...
    case TxoutType::WITNESS_V2_QRH: {
        WitnessV2QRH qrh;
        std::copy(vSolutions[0].begin(), vSolutions[0].end(), qrh.begin());
        addressRet = qrh;
        return true;
    }
...
public:
    ...
    CScript operator()(const WitnessV2QRH& qrh) const
    {
        return CScript() << OP_2 << ToByteVector(qrh);
    }
...
public:
    ...
    bool operator()(const WitnessV2QRH& dest) const { return true; }
