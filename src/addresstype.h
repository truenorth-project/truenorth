...
/** Pay-to-Quantum-Resistant-Hash (P2QRH, witness v2) destination.
 *  Wraps the 32-byte on-chain commitment; construction of the commitment from
 *  (scheme_id, pubkey, script_root) lives elsewhere. See doc/p2qrh.md. */
struct WitnessV2QRH : public BaseHash<uint256>
{
    WitnessV2QRH() : BaseHash() {}
    explicit WitnessV2QRH(const uint256& commitment) : BaseHash(commitment) {}
};
 ...
 *  * WitnessV2QRH: TxoutType::WITNESS_V2_QRH destination (P2QRH address; see doc/p2qrh.md)
 *  * PayToAnchor: TxoutType::ANCHOR destination (P2A address)
 *  * WitnessUnknown: TxoutType::WITNESS_UNKNOWN destination (P2W??? address)
 *  A CTxDestination is the internal data type encoded in a bitcoin address
 */
using CTxDestination = std::variant<CNoDestination, PubKeyDestination, PKHash, ScriptHash, WitnessV0ScriptHash, WitnessV0KeyHash, WitnessV1Taproot, WitnessV2QRH, PayToAnchor, WitnessUnknown>;
