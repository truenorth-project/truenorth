...
class ReplaceByFeeTest(BitcoinTestFramework):
    ...
    def test_simple_doublespend(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {tx.txid_hex}; new feerate 0.00300000 NORTH/kvB <= old feerate 0.00300000 NORTH/kvB"
    ...
    def test_incremental_relay_feerates(self):
        ...
        for incremental_setting in (0, 5, 10, 50, 100, 234, 1000, 5000, 21000):
            ...
            self.log.info(f"-> Test -incrementalrelayfee={incremental_setting:.8f}mie/kvB...")
