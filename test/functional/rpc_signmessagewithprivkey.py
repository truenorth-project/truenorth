...
class SignMessagesWithPrivTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Signed over the "TrueNorth Signed Message:\n" prefix (src/common/signmessage.cpp)
        expected_signature = 'IM/c7kokXGfcjPi3WOG6I4ZIx46x8v/LzCRcEHN+27DpWbouiUKu3pW09hdMoUNCXzKUOD31wv6TlM+9QA3qDlc='
