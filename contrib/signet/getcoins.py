...
parser = argparse.ArgumentParser(description='Script to get coins from a faucet.', epilog='You may need to start with double-dash (--) when providing truenorth-cli arguments.')
parser.add_argument('-c', '--cmd', dest='cmd', default='truenorth-cli', help='truenorth-cli command to use')
...
parser.add_argument('bitcoin_cli_args', nargs='*', help='Arguments to pass on to truenorth-cli (default: -signet)')
