...
complete --command truenorth-cli --no-files
...
complete --command truenorth-cli \
...
# Add commands
# Permit command completions after `truenorth-cli help` but not after other commands
complete \
    --command truenorth-cli \
    --no-files \
