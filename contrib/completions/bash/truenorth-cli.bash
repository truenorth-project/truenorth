# bash programmable completion for truenorth-cli(1)
# Copyright (c) 2012-2022 The Bitcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

# call $truenorth-cli for RPC
_bitcoin_rpc() {
...
_bitcoin_cli() {
    ...
    # save and use original argument to invoke truenorth-cli for -help, help and RPC
    # as truenorth-cli might not be in $PATH
    bitcoin_cli="$1"
...
complete -F _bitcoin_cli truenorth-cli
