#!/usr/bin/env bash
# Copyright (c) 2021 The TrueNorth Core developers
...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/truenorth.conf}
...
then
  ...
  echo -e "To safely generate a truenorth.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example truenorth.conf file in share/examples/'
...
##
## truenorth.conf configuration file.
...
# parse the output from truenorthd --help
